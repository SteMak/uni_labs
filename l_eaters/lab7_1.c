...
int lab7_1ScanPerson(int, int, struct Person *);
int lab7_1DeletePerson(int, int, struct Person *);
int lab7_1PrintPeople(int, int, struct Person *);

void addPerson(struct Person *, char *, int, float);
void deletePerson(struct Person *, int);

int lab7_1Menu(int cols, int rows, struct Person *people)
{
  char choicesFormat[Lab7_1Options][512] = {"Go back", "Add person", "Delete person", "Print people"};

  char *choices[Lab7_1Options];
  for (int i = 0; i < Lab7_1Options; i++)
...
int lab7_1DeletePerson(int cols, int rows, struct Person *people)
{
...
int lab7_1PrintPeople(int cols, int rows, struct Person *people)
{
  ...
  for (int i = 0; i < Lab7_1Max_People; i++)
